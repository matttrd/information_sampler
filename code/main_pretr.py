...
def main_worker(opt):
    ...
    if opt['pretrained']:
        ...
        if opt['orig_dataset'] == 'cifar10' and opt['arch'] in ['resnet10', 'resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152']:
            print("=> creating model '{}'".format(opt['arch']))
            model = getattr(cifar_models, opt['arch'])(num_classes=10)
        elif opt['orig_dataset'] == 'cifar100' and opt['arch'] in ['resnet10', 'resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152']:
            print("=> creating model '{}'".format(opt['arch']))
            model = getattr(cifar_models, opt['arch'])(num_classes=100)
        elif 'imagenet' in opt['orig_dataset'] and not '32' in opt['orig_dataset'] and opt['arch'] in ['resnet10', 'resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152']:
            print("=> creating model '{}'".format(opt['arch']))
    ...
    optimizer = torch.optim.SGD(classifier.parameters(), opt['lr'],
